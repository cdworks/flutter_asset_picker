...
class _CheckboxState extends State<CircleCheckBox> with TickerProviderStateMixin {
...
//    return RRect.fromRectAndRadius(rect, _kEdgeRadius);
  ...
  Color _colorAt(double t) {
    ...
    Color frameColor =  Color.lerp(Colors.white54, activeColor, t*4.0);

    return onChanged == null? inactiveColor : (t >= 0.25 ? activeColor :
    frameColor);
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (_oldValue == false || value == false) {
      ...
      if (t <= 0.5) {
        ...
        _drawCheck(canvas, origin, 1, Paint()
          ..color = _colorAt(t)
          ..style = PaintingStyle.stroke
          ..strokeWidth = _kStrokeWidth);
      } else {

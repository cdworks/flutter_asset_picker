...
typedef AssetRouteBuilder = AssetRouteWidget Function(BuildContext context);

mixin AssetRouteWidget on Widget
{
  bool isCancel = false;
}
...
class AssetCupertinoPageRoute<T> extends PageRoute<T> {
  ...
  final AssetRouteBuilder builder;
  ...
  static Widget assetBuildPageTransitions<T>(
      PageRoute<T> route,
      PageRoute<T> sliderRoute,
      bool isCancel,
      bool beginSlider,
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child) {
    ...
    return assetBuildPageTransitions<T>(route,this, widget == null ? false :
        widget
        .isCancel,
        beginSlider,
        context,
